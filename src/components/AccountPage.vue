<template>
  <div>
    ...
    <img class="wave huerotate" src="../assets/wave.png" />
    <div class="container">
      <div class="img">
      ...
      <div class="login-content">
        <form @submit.prevent="onCreatePost()">
          ...
          <div class="admin"> Go to admin
            <a @click="goto()">login </a>
          </div>
...
.huerotate { filter: hue-rotate(224deg); }
.admin{
  margin-top: 1rem;
  display: flex;
  gap: 0.3rem;
...
.btn {
  ...
  outline: none;
  border: none;
  background-image: linear-gradient(to right, #f86956, #fb543e, #f74129);
  background-size: 200%;
  font-size: 1.2rem;
  color: #fff;
  font-family: "Poppins", sans-serif;
